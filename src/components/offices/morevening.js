...
class MoreveningComponent extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
      brevity: undefined,
  ...
  render () {
    ...
    return (
      <div>
        ...
        <div><p><i>... with Evening Prayer readings. sshhhhhh</i></p></div>
...
MoreveningComponent.propTypes = {
  date: PropTypes.instanceOf(Date).isRequired
}

export default withRouter(MoreveningComponent)
